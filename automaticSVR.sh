...
### automaticSVR.sh
#
# One-stop script to perform automatic SVR with Deep Learning-based brain masking
#
# - USAGE: 
...
# - Copies files across for automatic SVR
...
#---------------------------------------------------------------------------------
path_autoSVRrecon_input=$path_fetalrep/auto-recon-files/brain
path_autoSVRrecon_output=$path_fetalrep/auto-recon-files/results-brain
